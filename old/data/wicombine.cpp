...
int main(int argc, char *argv[]){
	...
	if (wirefile.is_open()){
		while (!wirefile.eof()){
			...
			cwire.top=top;
			cwire.length=(float)atof(line.substr(0,6).c_str());
			cwire.gague=(float)atof(line.substr(7,2).c_str());
			...
			cwire.fromX=(float)(((((c+((b==2)?95:0))*-1500)+279111)*-0.002545333333)+741.6966045);
			cwire.fromY=(float)((((r*7000)-88725)*0.002544285714)+241.17975);
			...
			if ((cwire.toName[0]=='(') || (cwire.toName[0]=='[')){
				...
				cwire.toX=(float)(((((c+((b==2)?95:0))*-1500)+279111)*-0.002545333333)+741.6966045);
				cwire.toY=(float)((((r*7000)-88725)*0.002544285714)+241.17975);
			}
	...
	for (unsigned long i=0; i<extras.size(); i++){
		if (extras[i].type.find("Pin")!=string::npos){
			comfile << "X" << extras[i].x << "," << extras[i].y << ",P," << (extras[i].top?1:0) << endl;
		}else if (extras[i].type.find("100")!=string::npos){
			comfile << "X" << extras[i].x << "," << extras[i].y << ",1," << (extras[i].top?1:0) << endl;
		}else if (extras[i].type.find("75")!=string::npos){
			comfile << "X" << extras[i].x << "," << extras[i].y << ",2," << (extras[i].top?1:0) << endl;
		}else if (extras[i].type.find("50")!=string::npos){
			comfile << "X" << extras[i].x << "," << extras[i].y << ",3," << (extras[i].top?1:0) << endl;
		}else if (extras[i].type.find("39")!=string::npos){
			comfile << "X" << extras[i].x << "," << extras[i].y << ",4," << (extras[i].top?1:0) << endl;
		}
			/*
