...
if($highchan>640 && $highchan<=1408)
{
	$jobsize=22;
}
else if($highchan<=640)
{
	$jobsize=10;
}
else
...
$query = "INSERT INTO wiringjobs (`jid`,`size`,`wirecount`,`extracount`,`lowX`,`lowY`,`hiX`,`hiY`,`hasTop`,`calibration`) VALUES ('".$jid."','X','".count($wires)."','0','".$lowX."','".$lowY."','".$hiX."','".$hiY."','0','SPC/".$jobsize.",SPIF/".$jobsize."');";
...
//	printf("%d",$matches[ToX]);
//	printf("%d",$matches[ToY]);
//	var_dump($matches);
